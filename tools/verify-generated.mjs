 ...
 *   대상: units/ · guides/ · grammar/ · 404.html · sitemap.xml (모두 tools/build-pages.mjs 산출물)
 *
...
const TARGETS = ["units", "guides", "grammar", "404.html", "sitemap.xml"];
...
];  console.log("🧾 생성물 검증 (units · guides · grammar · 404.html · sitemap.xml)");
