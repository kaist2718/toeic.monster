  ...
  chapters: [
    {
      no: 1,
      title: "문장의 뼈대와 be동사",
      intro: "토익 Part 5·6의 모든 문제는 주어와 동사를 찾는 데서 시작합니다. be동사 자리를 눈으로 먼저 잡아 두면 뒤에 나오는 수일치·시제 문제가 훨씬 쉬워집니다.",
    ...
    },
    {
      no: 2,
      title: "일반동사와 3인칭 단수",
      intro: "3인칭 단수 -s는 토익에서 가장 자주 나오는 수일치 함정입니다. 주어와 동사 사이에 수식어가 끼어도 동사를 찾아낼 수 있도록, 예문에서 주어와 동사를 짝지어 읽어 보세요.",
    ...
    },
    {
      no: 3,
      title: "명사·관사·복수형",
      intro: "Part 5 어휘 문제는 관사 뒤에 명사가 오는지로 답이 갈리는 경우가 많습니다. 셀 수 있는 명사인지 판단하는 감각을 먼저 잡으면 어형 문제까지 함께 풀립니다.",
    ...
    },
    {
      no: 5,
      title: "현재시제와 현재진행형",
      intro: "시제 문제는 now·every day 처럼 “언제”를 알려 주는 표현과 함께 나옵니다. 두 시제의 쓰임을 나란히 익혀 두면 Part 5에서 문장을 끝까지 읽지 않고도 답을 고를 수 있습니다.",
    ...
    },
    {
      no: 6,
      title: "과거시제와 과거진행형",
      intro: "불규칙 동사는 외운 만큼 바로 점수가 됩니다. 과거형·과거분사 표를 소리 내어 읽고, 지문에서 시제가 바뀌는 지점(날짜·시간 표현)을 표시하며 읽어 보세요.",
    ...
    },
    {
      no: 10,
      title: "의문문과 부가의문문",
      intro: "Part 2는 질문의 형태를 알아야 응답이 보입니다. 의문사별로 무엇을 묻는지 정리해 두고, 부가의문문은 대답 방향(Yes/No)까지 함께 익혀 두세요.",
    ...
    },
    {
      ...
      intro: "“무엇이 있다·없다”를 묻는 문제는 There is/are 구문이 단서입니다. some 과 any 의 쓰임을 같이 익혀 두면 안내문·공지 지문이 한결 쉬워집니다.",
