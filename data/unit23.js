...
window.VOCAB_UNITS[23] = [
  ...
  ["leadership", "/ˈliːdərʃɪp/", "리-더-십", "지도력, 리더십", "The company values strong leadership at every level of management.", "그 회사는 모든 관리 단계에서 강한 리더십을 중시한다.", "더 컴-퍼-니 밸-류즈 스트롱 리-더-십 앳 에-브리 레-벨 오브 매-니지-먼트"],
  ...
  ["respect", "/rɪˈspekt/", "리-스펙트", "존경, 존중하다", "Employees respect the manager's decisions because she explains them.", "직원들은 설명을 해 주기 때문에 매니저의 결정을 존중한다.", "임-플로이-이즈 리-스펙트 더 매-니-저즈 디-시-전즈 비-코즈 시 익-스플레인즈 뎀"],
  ...
  ["appreciate", "/əˈpriːʃieɪt/", "어-프리-시-에이트", "감사하다, 높이 평가하다", "We appreciate your continued support throughout this difficult project.", "이 어려운 프로젝트 내내 지속적인 지원에 감사드립니다.", "위 어-프리-시-에이트 유어 컨-티-뉴드 서-포트 쓰루-아웃 디스 디-피-컬트 프라-젝트"],
  ...
  ["peer", "/pɪr/", "피어", "동료, 또래", "Her peers respect her opinion during team meetings.", "그녀의 동료들은 팀 회의에서 그녀의 의견을 존중한다.", "허 피어즈 리-스펙트 허 어-핀-년 듀-링 팀 미-팅즈"],
  ...
  ["motivation", "/ˌmoʊtɪˈveɪʃn/", "모우-티-베이-션", "동기 부여", "The bonus increased employee motivation across all departments.", "보너스는 모든 부서에서 직원들의 동기를 높였다.", "더 보우-너스 인-크리스트 임-플로이-이 모우-티-베이-션 어-크로스 올 디-파트-먼츠"],
