...
window.VOCAB_UNITS[18] = [
  ...
  ["rental", "/ˈrentl/", "렌-털", "임대, 임대료", "The rental price includes utilities and weekly cleaning service.", "임대료에는 공과금과 주간 청소 서비스가 포함된다.", "더 렌-털 프라이스 인-클루즈 유-틸-러-티즈 앤 위크-리 클리-닝 서-비스"],
  ...
  ["bathroom", "/ˈbæθruːm/", "배스-룸", "욕실", "The apartment has two bathrooms and a large kitchen.", "그 아파트에는 욕실이 두 개 있고 주방이 넓다.", "디 어-파-트먼트 해즈 투 배스-룸즈 앤 어 라지 키-친"],
  ...
  ["neighborhood", "/ˈneɪbərhʊd/", "네이-버-후드", "이웃, 주변 지역", "This is a quiet neighborhood close to the subway station.", "여기는 지하철역에서 가까운 조용한 주택가이다.", "디스 이즈 어 콰이-엇 네이-버-후드 클로우즈 투 더 서브-웨이 스테이-션"],
  ["downtown", "/ˌdaʊnˈtaʊn/", "다운-타운", "시내, 도심", "The office is located downtown, near the central library.", "사무실은 중앙 도서관 근처 시내에 있다.", "디 오-피스 이즈 로우-케이-티드 다운-타운 니어 더 센-트럴 라이-브러-리"],
