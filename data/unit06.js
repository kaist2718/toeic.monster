...
window.VOCAB_UNITS[6] = [
  ...
  ["profession", "/prəˈfeʃn/", "프러-페-션", "전문 직업", "Teaching is a respected profession in many countries.", "교직은 많은 나라에서 존경받는 전문 직업이다.", "티-칭 이즈 어 리-스펙-티드 프러-페-션 인 매-니 컨-트리즈"],
  ["professional", "/prəˈfeʃənl/", "프러-페-셔-널", "전문가의, 전문적인", "The presentation looked very professional from start to finish.", "그 발표는 처음부터 끝까지 매우 전문적으로 보였다.", "더 프레-전-테이-션 룩트 베-리 프러-페-셔-널 프럼 스타트 투 피-니시"],
