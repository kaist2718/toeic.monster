...
window.VOCAB_UNITS[26] = [
  ...
  ["temperature", "/ˈtemprətʃər/", "템-프러-처", "기온, 온도", "The temperature dropped below freezing during the night.", "밤사이 기온이 영하로 떨어졌다.", "더 템-프러-처 드랍트 비-로우 프리-징 듀-링 더 나이트"],
  ["season", "/ˈsiːzn/", "시-즌", "계절", "Fruits are cheaper in season and taste much better.", "제철 과일은 더 싸고 맛도 훨씬 좋다.", "프루츠 아 치-퍼 인 시-즌 앤 테이스트 머치 베-터"],
  ...
  ["earth", "/ɜːrθ/", "어스", "지구, 흙", "The satellite orbits the earth once every ninety minutes.", "그 위성은 90분마다 한 번씩 지구를 돈다.", "더 새-털-라이트 오-빗츠 디 어스 원스 에-브리 나인-티 미-닛츠"],
  ...
  ["sea", "/siː/", "시", "바다", "The hotel overlooks the sea and has a small private beach.", "그 호텔은 바다를 내려다보며 작은 개인 해변도 있다.", "더 호우-텔 오우-버-룩스 더 시 앤 해즈 어 스몰 프라이-빗 비치"],
  ...
  ["animal", "/ˈænɪml/", "애-니-멀", "동물", "The zoo protects endangered animals and runs a breeding program.", "그 동물원은 멸종 위기 동물을 보호하고 번식 프로그램을 운영한다.", "더 주 프러-텍츠 인-데인-저드 애-니-멀즈 앤 런즈 어 브리-딩 프로우-그램"],
  ...
  ["ecosystem", "/ˈiːkoʊsɪstəm/", "이-코우-시스-텀", "생태계", "Pollution harms the marine ecosystem along the southern coast.", "오염은 남부 해안의 해양 생태계를 해친다.", "퍼-루-션 함즈 더 머-린 이-코우-시스-텀 어-롱 더 서-던 코우스트"],
  ...
  ["landfill", "/ˈlændfɪl/", "랜드-필", "매립지", "The landfill is almost full, so the city opened a new site.", "그 매립지가 거의 가득 차서 시는 새 부지를 열었다.", "더 랜드-필 이즈 올-모우스트 풀 소우 더 시-티 오-픈드 어 뉴 사이트"],
  ["emission", "/ɪˈmɪʃn/", "이-미-션", "배출, 배출량", "The new law limits carbon emissions.", "새 법은 탄소 배출을 제한한다.", "더 누 로 리-밋츠 카-번 이-미-션즈"],
  ["greenhouse gas", "/ˈɡriːnhaʊs ɡæs/", "그린-하우스 개스", "온실가스", "Greenhouse gases cause global warming and extreme weather events.", "온실가스는 지구 온난화와 극단적 기상 현상을 일으킨다.", "그린-하우스 개-시즈 코즈 글로우-블 워-밍 앤 익-스트림 웨-더 이-벤츠"],
  ...
  ["sustainable", "/səˈsteɪnəbl/", "서-스테이-너-블", "지속 가능한", "The company uses sustainable packaging to reduce plastic waste.", "그 회사는 플라스틱 폐기물을 줄이려고 지속 가능한 포장재를 쓴다.", "더 컴-퍼-니 유-지즈 서-스테이-너-블 패-키-징 투 리-듀스 플래스-틱 웨이스트"]
];