...
window.VOCAB_UNITS[19] = [
  ...
  ["study", "/ˈstʌdi/", "스터-디", "공부하다, 연구", "She studies English every morning before she starts work.", "그녀는 일을 시작하기 전에 매일 아침 영어를 공부한다.", "시 스터-디즈 잉-글리시 에-브리 모-닝 비-포어 시 스타츠 워크"],
  ...
  ["major", "/ˈmeɪdʒər/", "메이-저", "전공, 주요한", "Her major is international business with a focus on marketing.", "그녀의 전공은 마케팅을 중점으로 한 국제 경영이다.", "허 메이-저 이즈 인-터-내-셔-널 비즈-니스 위드 어 포우-커스 온 마-킷-팅"],
