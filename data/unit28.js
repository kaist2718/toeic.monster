...
window.VOCAB_UNITS[28] = [
  ...
  ["date", "/deɪt/", "데이트", "날짜", "Please confirm the delivery date by the end of today.", "오늘 안으로 배송 날짜를 확인해 주세요.", "플리즈 컨-펌 더 디-리-버-리 데이트 바이 디 엔드 오브 투-데이"],
  ...
  ["yesterday", "/ˈjestərdeɪ/", "예스-터-데이", "어제", "The meeting was postponed yesterday because the client was ill.", "고객이 아팠기 때문에 그 회의는 어제 연기되었다.", "더 미-팅 워즈 포우-스포운드 예스-터-데이 비-코즈 더 클라이-언트 워즈 일"],
  ...
  ["immediately", "/ɪˈmiːdiətli/", "이-미-디-엇-리", "즉시, 곧바로", "Please contact the office immediately if the shipment is delayed.", "배송이 지연되면 즉시 사무실에 연락하세요.", "플리즈 칸-택트 디 오-피스 이-미-디-엇-리 이프 더 쉽-먼트 이즈 디-레이드"],
  ["immediate", "/ɪˈmiːdiət/", "이-미-디-엇", "즉각적인", "The problem needs immediate action from the maintenance team.", "그 문제는 유지 보수팀의 즉각적인 조치가 필요하다.", "더 프라-블럼 니즈 이-미-디-엇 액-션 프럼 더 메인-터-넌스 팀"],
  ...
  ["quarterly", "/ˈkwɔːrtərli/", "콰-터-리", "분기별의", "The company publishes quarterly reports for its investors.", "그 회사는 투자자들을 위해 분기별 보고서를 발행한다.", "더 컴-퍼-니 퍼-블리-시즈 콰-터-리 리-포-츠 포 잇츠 인-베스-터즈"],
  ["monthly", "/ˈmʌnθli/", "먼스-리", "매월의, 월간의", "The magazine is published monthly and delivered to members.", "그 잡지는 매월 발행되어 회원에게 배달된다.", "더 매-거-진 이즈 퍼-블리시트 먼스-리 앤 디-리-버드 투 멤-버즈"],
