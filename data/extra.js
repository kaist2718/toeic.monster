...
window.TOEIC_EXTRA = {
  ...
  frequency: [
    ...
    ["expense", "경비", "명사"], ["attendee", "참석자", "명사"], ["flexible", "유연한", "형용사"],    ["maintain", "유지하다", "동사"], ["reschedule", "일정을 변경하다", "동사"], ["supervisor", "관리자", "명사"], ["acquire", "확득하다", "동사"], ["qualify", "자격을 갖추다", "동사"], ["recent", "최근의", "형용사"],
    ["obtain", "연다", "동사"], ["distribute", "배포하다", "동사"], ["period", "기간", "명사"],
