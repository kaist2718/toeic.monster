...
window.VOCAB_UNITS[24] = [
  ...
  ["efficiency", "/ɪˈfɪʃnsi/", "이-피-션-시", "효율, 능률", "The training improved work efficiency in the accounting team.", "그 교육은 회계팀의 업무 효율을 높였다.", "더 트레이-닝 임-프루브드 워크 이-피-션-시 인 디 어-카운-팅 팀"],
  ...
  ["productivity", "/ˌproʊdʌkˈtɪvəti/", "프라-덕-티-버-티", "생산성", "Better tools increase worker productivity without longer working hours.", "더 좋은 도구는 노동 시간을 늘리지 않고도 생산성을 높인다.", "베-터 툴즈 인-크리스 워-커 프라-덕-티-버-티 위-아웃 롱-거 워-킹 아워즈"],
  ...
  ["measure", "/ˈmeʒər/", "메-저", "측정하다, 대책", "We measure customer satisfaction quarterly and share the results.", "우리는 분기마다 고객 만족도를 측정해 결과를 공유한다.", "위 메-저 커스-터-머 새-티스-팩-션 콰-터-리 앤 셰어 더 리-절츠"],
