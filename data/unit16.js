...
window.VOCAB_UNITS[16] = [
  ...
  ["plate", "/pleɪt/", "플레이트", "접시", "The waiter cleared our plates as soon as we finished.", "웨이터는 우리가 다 먹자마자 접시를 치웠다.", "더 웨이-터 클리어드 아워 플레이츠 애즈 수운 애즈 위 피-니시트"],
  ["bowl", "/boʊl/", "보울", "그릇, 사발", "The soup is served in a large bowl.", "수프는 큰 그릇에 제공된다.", "더 수프 이즈 서브드 인 어 라지 보울"],
  ["delicious", "/dɪˈlɪʃəs/", "디-리-셔스", "맛있는", "The pasta was absolutely delicious, so we ordered it again.", "파스타가 정말 맛있어서 우리는 다시 주문했다.", "더 파스-터 워즈 앱-서-루트-리 디-리-셔스 소우 위 오-더드 잇 어-겐"],
