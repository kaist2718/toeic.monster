...
window.VOCAB_UNITS[22] = [
  ...
  ["gallery", "/ˈɡæləri/", "갤-러-리", "갤러리, 화랑", "The gallery displays modern paintings by local artists.", "그 화랑은 지역 작가들의 현대 회화를 전시한다.", "더 갤-러-리 디-스플레이즈 마-던 페인-팅즈 바이 로-컬 아-티스츠"],
  ...
  ["pedestrian", "/pəˈdestriən/", "퍼-데스-트리-언", "보행자", "Pedestrians should use the crosswalk when the light is green.", "보행자는 신호등이 녹색일 때 횡단보도를 이용해야 한다.", "퍼-데스-트리-언즈 슈드 유즈 더 크로스-워크 웬 더 라이트 이즈 그린"],
