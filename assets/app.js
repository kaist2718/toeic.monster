...
(function () {
  ...
  // ---------- 분석 이벤트 (비활성) ----------
  // 방문 분석은 자체 호스팅 분석기를 씁니다(assets/analytics.js). 페이지뷰·체류시간·
  // 유입 경로는 자동으로 수집되지만, 아래 track(...) 이 나타내는 **커스텀 이벤트**
  // (quiz_start 등)는 현재 수집기에 없는 기능이라 **이름만 남겨 둡니다**
  // (어떤 기능을 세던 것인지의 기록입니다). 이벤트를 지원하게 되면 이 함수 하나만 되살리면 됩니다.
  function track() { /* 커스텀 이벤트는 아직 수집하지 않습니다 */ }
